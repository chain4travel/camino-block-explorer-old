    ...
    <q-card-section>
      <q-list dense>
        <DetailField
          ...
          type="monospace"
          :allow-copy="true"
          :xl-length="breakPoints[4]"
          :lg-length="breakPoints[3]"
          :md-length="breakPoints[2]"
          :sm-length="breakPoints[1]"
          :xs-length="breakPoints[0]"
        />
        <DetailField
          v-if="fund.signature"
          icon="mdi-help-circle-outline"
          field="Signature"
          :value="fund.signature"
          type="monospace"
          :xl-length="breakPoints[4]"
          :lg-length="breakPoints[3]"
          :md-length="breakPoints[2]"
