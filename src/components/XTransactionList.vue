        ...
        <div class="col-lg-4 col-sm-3 col-12 q-pt-sm">
          <div class="row">
            <div class="col-md-8 col-12">
              <long-string class="monospace" :value="item.id" :xl-length="46" :lg-length="32" :md-length="16"
                :sm-length="14" :xs-length="28"></long-string>
            </div>
            <div class="col-auto">
            ...
            <div :class="'col'">
              <div class="row items-center" :key="ad.id" v-for="ad in item.from">
                <div :class="'col self-center' + ($q.screen.xs ? ' col-xs-12' : '')">
                  <long-string class="monospace" :value="ad.address" :xl-length="46" :lg-length="32" :md-length="14"
          ...
          <div :class="'row'">
            ...
            <div :class="'col'">
              <div
                ...
                <div :class="'col self-center' + ($q.screen.xs ? ' col-xs-12' : '')">
                  <address-link class="monospace" :value="(getAddressPrefix() || '') + ad.address" :xl-length="46"
                    :lg-length="32" :md-length="14" :sm-length="10" :xs-length="28"></address-link>
                  <!-- <long-string class="monospace" :value="ad.address" :xl-length="46" :lg-length="32" :md-length="14"
                    :sm-length="10" :xs-length="28"></long-string> -->
                </div>
                <div class="col-auto text-right">
